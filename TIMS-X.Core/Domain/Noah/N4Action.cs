...
namespace TIMS_X.Core.Domain.Noah
{
    public class N4Action
    {
        ...
        public byte[] FastViewData { get; set; }
        public int FastViewDataType { get; set; }
        public int FastViewVersion { get; set; }
        public Guid ActionGuid { get; set; }
        //public Guid ActionGroupGuid { get; set; }
        //public DateTime FastViewDateCreated { get; set; }
        //public DateTime FastViewDateModified { get; set; }
        public N4Session Session { get; set; }
