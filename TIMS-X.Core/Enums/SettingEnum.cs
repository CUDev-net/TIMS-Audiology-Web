...
namespace TIMS_X.Core.Enums
{
	public enum SettingEnum
	{
        ...
        /// 
        /// </summary>
        [Description(@"Can Create POS Items"), Area(SettingAreaEnum.POS)]
        CanCreatePOS = 16,
        /// <summary>
        /// 
        /// </summary>
        ...
        /// </summary>
        [Description(@"Can Create Appointments"), Area(SettingAreaEnum.Appointment)]
        ...
        /// Can view all tasks
        /// </summary>
        [Description(@"Can View All Tasks"), Area(SettingAreaEnum.Tasks)]
        CanViewAllTasks = 90,
        /// <summary>
        ...
        /// </summary>
        [Description("Can Access Conversations"), Area(SettingAreaEnum.SystemCenter)]
        CanAccessConversations = 105,

        /// <summary>
        /// Can view conversations
        /// </summary>
        [Description("Can Modify SQL Credentials"), Area(SettingAreaEnum.Setup)]
        CanModifySqlCredentials = 106,

        [Description("Can Access User Management"), Area(SettingAreaEnum.SystemCenter)]
        CanAccessUserManagement = 107,

        [Description("Can Clear Patient Letter List"), Area(SettingAreaEnum.SystemCenter)]
        ClearPatientLetterList = 108,

        /// <summary>
        /// Is the user allowed to upload videos
        /// </summary>
        [Description("Can Upload Videos"), Area(SettingAreaEnum.Imaging)]
        CanUploadVideos = 109,

        [Description("Can Add Task Types"), Area(SettingAreaEnum.Tasks)]
        CanAddTaskTypes = 110,

        [Description("Can Add History Types"), Area(SettingAreaEnum.History)]
        CanAddHistoryTypes = 111,

        /// <summary>
        /// 
        /// </summary>
        [Description("Can Delete Questionnaires"), Area(SettingAreaEnum.History)]
        CanDeleteQuestionnaires = 112,
        /// <summary>
        /// Uses Noah
        /// </summary>
        [Description("Uses Noah Tools"), Area(SettingAreaEnum.History)]
        UseNoahTools = 113,
        /// <summary>
        /// Can Add Modify Appointments
        /// </summary>
        [Description(@"Can Modify Appointments"), Area(SettingAreaEnum.Appointment)]
        CanModifyAppointments = 114,

        /// <summary>
        /// Mantis 4762, need separate permission to delete tasks
        /// </summary>
        [Description("Can Delete Non-Completed Tasks"), Area(SettingAreaEnum.Tasks)]
        CanDeleteTasks = 115,

        /// <summary>
        /// Can Access Digital Intake Center
        /// </summary>
        [Description(@"Can Access Digital Intake Center"), Area(SettingAreaEnum.SystemCenter)]
        CanAccessDigitalIntake = 116,

        /// <summary>
        /// Can Export Patient Documents
        /// </summary>
        [Description(@"Can Export Patient Documents"), Area(SettingAreaEnum.Patient)]
        CanExportPatientDocuments = 117,

        [Description(@"Can Create Non-Patient Appointments"), Area(SettingAreaEnum.Appointment)]
        CanCreateNonPatientAppointments = 118,

        [Description(@"Can Modify Non-Patient Appointments"), Area(SettingAreaEnum.Appointment)]
        CanModifyNonPatientAppointments = 119,

        [Description(@"Can Setup Auto Appointment Notifications"), Area(SettingAreaEnum.Appointment)]
        CanSetupAutoAppointmentNotifications = 120,

        [Description(@"Can Setup AR Task"), Area(SettingAreaEnum.POS)]
        CanSetupARTask = 121,

        [Description(@"Can Modify POS Items"), Area(SettingAreaEnum.POS)]
        CanModifyPOS = 122,

        [Description(@"Can Delete POS Items"), Area(SettingAreaEnum.POS)]
        CanDeletePOS = 123,

        [Description(@"Can Inactivate Histories"), Area(SettingAreaEnum.History)]
        CanInactivateHistories = 124,

        [Description(@"Can Archive Diagnostic Reports"), Area(SettingAreaEnum.Reports)]
        CanArchiveDiagnosticReports = 125
    }
}
