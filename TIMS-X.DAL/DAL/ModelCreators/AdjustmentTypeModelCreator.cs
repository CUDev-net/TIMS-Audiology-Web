...
internal class AdjustmentTypeModelCreator : IModelCreator
{
    public void CreateModel(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AdjustmentType>(entity =>
        {
            ...
            entity.Property(e => e.QuickBookAccountId).HasColumnName("QBAccountID");
            ...
            entity.ToTable(nameof(AdjustmentType));
        });
    }
}